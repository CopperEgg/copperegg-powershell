        ...
        if( $mg -ne $null ){
          ...
          $widgets = @{
            ...
            "15" = @{
                  ...
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "15", $warray[15].name);
                   };
            "16" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "16", $warray[16].name);
                   };
            "17" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "17", $warray[17].name);
                   };
            "18" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "18", $warray[18].name);
                   };
            "19" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "19", $warray[19].name);
                   };
            "20" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "20", $warray[20].name);
                   };
            "21" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "21", $warray[21].name);
                   };
            "22" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "22", $warray[22].name);
                   };
            "23" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "23", $warray[23].name);
                   };
            "24" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "24", $warray[24].name);
                   };
            "25" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "25", $warray[25].name);
                   };
            "26" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "26", $warray[26].name);
                   };
            "27" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "27", $warray[27].name);
                   };
            "28" = @{
                  "type"="timeline";
                  "style"="values";
                  "match"="all";
                  "metric" = @($gname, "28", $warray[28].name);
                   }
          }
